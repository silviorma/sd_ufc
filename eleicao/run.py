...
if sys.platform.find("win") != -1:
    ...
    os.system("start /wait cmd /c rmiregistry")
    os.system("start /wait cmd /c cd bin; java server.Peer 8888")
    os.system("start /wait cmd /c cd bin; java server.Peer 8889")
    os.system("start /wait cmd /c cd bin; java server.Peer 8890")
    os.system("start /wait cmd /c cd bin; java server.Peer 8891")
    os.system("start /wait cmd /c cd bin; java server.Peer 8892")
